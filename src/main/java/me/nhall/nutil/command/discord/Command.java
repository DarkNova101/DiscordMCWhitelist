...
public abstract class Command extends ListenerAdapter {
    ...
    public void onMessageReceived(MessageReceivedEvent e) {
        ...
        if (containsCommand(e.getMessage())) onCommand(e, commandArgs(e.getMessage()));
    }
    ...
    protected Message sendMessage(MessageReceivedEvent e, Message message) {
        if (e.isFromType(ChannelType.PRIVATE)) return e.getPrivateChannel().sendMessage(message).complete();
        else return e.getTextChannel().sendMessage(message).complete();
    }
